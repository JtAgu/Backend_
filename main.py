...
NMedicina=1
Personas.append(Persona("Justin","Aguirre","2001-11-15","M","Jt","1234","35403037","Paciente"))
Personas.append(Persona("Keylin","Cardona","1999-12-23","F","Kl","1234","35403037","Enfermera"))
Personas.append(Persona("Hellen","Herrera","2003-03-21","F","Hh","1234","35403037","Paciente"))
Personas.append(Persona("Mary","Cruz","2003-10-22","F","MC","1234","35403037","Paciente"))


Enfermedades.append(Enfermedad("Fractura",1))

Doctores.append(Doctor("Martin","Lutero","2003-10-22","M","ML","1234","83746822","Cardiologia",0))
Doctores.append(Doctor("Justin","Aguirre","2003-10-22","M","Jt2","1234","35403037","Dermatologia",0))
Doctores.append(Doctor("Kanuto","xd","2003-10-22","M","KxD","1234","83746822","Cardiologia",0))
Doctores.append(Doctor("Nobita","Vamos a por ti","2003-10-22","M","No","1234","35403037","Dermatologia",0))

Medicinas.append(Medicina(NMedicina,"Paracetamol",100,"Cura Todo",25,0))
NMedicina=NMedicina+1
Medicinas.append(Medicina(NMedicina,"Ibuprofeno",10,"Cura casi Todo",25,0))
NMedicina=NMedicina+1
Medicinas.append(Medicina(NMedicina,"Quimio en tableta",1000,"No hace nada",30,0))
NMedicina=NMedicina+1
Medicinas.append(Medicina(NMedicina,"Gripetin",15,"No hace nada",10,0))
